Gem::Specification.new do |s|
  ...
  s.files = ["README", "Rakefile", "TODO", "lib/acts_as_overflowable.rb", "test/active_record_test_helper.rb", "test/fixtures", "test/functional", "test/integration", "test/mocks", "test/test_helper.rb", "test/unit", "test/mocks/development", "test/mocks/test", "test/unit/acts_as_overflowable_test.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://}
  s.require_paths = ["lib"]
